...
+(NSString *)URLForSearchString: (NSString *)searchString latitude:(NSString *)latitude longitude:(NSString *)longitude {
    ...
    return [NSString stringWithFormat:@"https://api.foursquare.com/v2/venues/search?client_id=%@&client_secret=%@&v=20180323&ll=%@,%@&query=%@", clientID, clientSecret, latitude, longitude, searchString];
}
